    ...
    return (
        <div className='extrapage'>
            ...
            <div className='pgleft pgcommon'>
                ...
                <div>
                    <h1>Our Story</h1>
                    <p>Contact UsThank you for your interest in CamMarket! We're here to assist you in any way we can.</p>
                         <div> Please feel free to reach out to us using the contact information provided below:
                            <div> Address:kotto mauryvanas
                         Phone:+237678947982
                         Email:achapipentashi@gmail.com</div>
                        </div>
                        <pre> Social Media:Connect with us on social media for updates, promotions, and more:FacebookTwitterInstagramFeedback:We look forward to hearing from you!</pre>
